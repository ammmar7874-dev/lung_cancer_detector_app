    ...
    return Container(
      ...
      child: ListTile(
        leading: Container(
          ...
          child: Icon(Icons.language, color: Colors.teal.shade700, size: 24),
        ),
        title: Text(
          'Language',
          style: GoogleFonts.poppins(
              ...
              .map(
                (lang) => ListTile(
                  ...
                  trailing: _selectedLanguage == lang
                      ? Icon(Icons.check, color: Colors.teal.shade700)
                      : null,
                  onTap: () {
                    setState(() {
